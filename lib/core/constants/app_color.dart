...
class AppColor {
  ...
  static Color contextThemeColor(
      BuildContext context, Color lightTheme, Color darkTheme) {
...
const String iosPackage = 'com.highfurries.user';
String projectName = "High Furries";
String aboutUSUrl = "https://highfurries.com/about/";
const String iosLink = 'https://apps.apple.com/id';
const String iosAppId = '1:901655269491:ios:addc91b7c566e8c86e9a06';
String appPackageName = "com.highfurries.user";
// App store links - removed Google Play reference for App Store compliance
const String appStoreLink = 'https://apps.apple.com/app/high-furries/id123456789';
const String genericAppLink = 'https://highfurries.com/download'; // Generic download link
